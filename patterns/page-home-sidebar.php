...
<article class="wp-block-group post loop-item is-vertical"><!-- wp:template-part {"slug":"post-header","tagName":"header","className":"post-header wp-block-template-post-header"} /-->
