<?php
/**
 * Title: Emulsion Front Page
 * Slug: emulsion/page-front-page
 * Categories: recently-added, layout, emulsion
 * Post Types: page, wp_template
 * Template Types: front-page
 * Inserter: no
 * Keywords: page
 * Description: Front Page Example
 */
?>
<!-- wp:template-part {"slug":"header-rich","tagName":"header","className":"fse-header header-layer alignfull is-pattern-front-page"} /-->

<!-- wp:pattern {"slug":"emulsion/primary-menu", "align":"full"} /-->
    ...
    <div class="wp-block-column main">
        ...
        <main class="wp-block-group alignfull"><!-- wp:group {"align":"full","className":"article-wrapper","layout":{"type":"constrained"}} -->
            <div class="wp-block-group alignfull article-wrapper"><!-- wp:group {"className":"alignfull post"} -->
                <div class="wp-block-group alignfull post">
					<!-- wp:template-part {"slug":"theme-front-page-demo","align":"full","className":"alignfull entry-content wp-block-template-part-theme-front-page-demo"} /--></div>
                <!-- /wp:group --></div>
            <!-- /wp:group --></main>
        <!-- /wp:group -->
    </div>
