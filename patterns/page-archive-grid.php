<?php
/**
 * Title: Emulsion Grid Page
 * Slug: emulsion/page-archive-grid
 * Categories: recently-added, layout, emulsion
 * Template Types: archive, category, tag, author, date, posts, front-page
 * Inserter: no
 * Keywords: archive
 * Description: Grid Layout Pattern
 */
?>
<!-- wp:template-part {"slug":"header","tagName":"header","align":"full","className":"fse-header header-layer banner wp-block-template-part-header alignfull is-pattern-archive-grid"} /-->
...
<article class="wp-block-group post loop-item"><!-- wp:template-part {"slug":"post-header","tagName":"header","className":"post-header wp-block-template-post-header centered"} /-->
