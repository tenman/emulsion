...
if ( is_page() ) {
	...
	if ( is_active_sidebar( 'sidebar-1' ) && emulsion_the_theme_supports( 'sidebar' ) && $emulsion_logged_in && $emulsion_metabox_post_control ) {
		?><aside class="sidebar-widget-area post-sidebar  <?php echo function_exists( 'emulsion_element_classes' ) ? esc_attr( emulsion_element_classes( 'sidebar-widget-area' ) ) : ''; ?> <?php emulsion_template_part_names_class( __FILE__ ) ?>"><ul class="sidebar-widget-area-lists"><?php
