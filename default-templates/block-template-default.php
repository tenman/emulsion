...
<!-- wp:group {"className":"post-header wp-block-template-post-header wp-block-template-part centered alignfull"} -->
<div class="wp-block-group post-header wp-block-template-post-header wp-block-template-part centered alignfull"><!-- wp:group {"className":"post-header-content","layout":{"type":"default"}} -->
...
<nav class="wp-block-group wp-block-post-navigation"><!-- wp:post-navigation-link {"showTitle":true} /--><!-- wp:post-navigation-link {"type":"previous","showTitle":true} /--></nav>
<!-- /wp:group -->
